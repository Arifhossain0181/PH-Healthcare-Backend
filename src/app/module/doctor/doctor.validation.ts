...
export const updateDoctorZod = z.object({
    password: z.string("Password is required").min(6, "Password must be at least 6 characters long").max(20, "Password must be less than 100 characters long").optional(),
  doctor: z.object({
    name: z.string("Name is required").min(5, "Name must be at least 5 characters long").max(30, "Name must be less than 100 characters long").optional(),
    email: z.email("Invalid email format").optional(),
    contactNumber: z.string("Contact number is required").min(11, "Contact number must be at least 11 characters long").max(15, "Contact number must be less than 15 characters long").optional(),
